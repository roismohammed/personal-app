...
import { File01Icon, Github01Icon, InstagramIcon, Linkedin01Icon, TiktokFreeIcons } from '@hugeicons/core-free-icons';
                            ...
                            <div className="grid grid-cols-1 gap-4 lg:grid-cols-4  ">
                                ...
                                <div className="lg:col-span-1 flex lg:sticky lg:top-30 self-start flex-col items-center lg:items-start">
                                    <div className="relative mb-8">
                                        <div className="w-64 h-64 bg-gradient-to-br from-cyan-500 to-teal-600 rounded-2xl shadow-2xl flex items-center justify-center">
                                            <Image
                                                src={myImage}
                                                alt="Profile"
                                ...
                                <div className="lg:col-span-3 space-y-6 mt-5 lg:mt-0">
                                    <div>
                                        <h2 className="text-2xl font-bold text-slate-900 dark:text-gray-200 mb-4">Hello! 👋</h2>
                                    ...
                                    <Link href="/resume">
                                        <Button variant="outline" className='cursor-pointer dark:text-gray-200'>
                                            <HugeiconsIcon
                                                icon={File01Icon}
                                                size={24}
                                                color="currentColor"
                                    ...
                                    <div className='mt-8'>
                                        <p className='text-xl font-bold text-slate-800 dark:text-gray-200 mb-4 z-10'>Tech Stack</p>
                                        <div className='-mt-10'>
                                            <MarqueeDemo />
                                        </div>
                                    </div>
                                    ...
                                    {/* Contact Info */}
                                    <p className='text-xl font-bold text-slate-800 dark:text-gray-200 mb-4 z-10'>Lets Connect</p>
                                    <p className="text-md text-slate-600 dark:text-gray-200 leading-relaxed mb-6">Questions or collaborations? Reach out to me at <a href="mailto: id.roismohammed@gmail.com" className='text-blue-600 hover:underline cursor-pointer'>id.roismohammed@gmail.com</a> or connect through social media. Lets build something amazing together!</p>
                                    ...
                                    <div className="flex gap-4">
                                        {[
                                            { icon: Github01Icon, href: "https://github.com/roismohammed", color: "text-slate-700  dark:text-gray-200 hover:text-slate-900" },
                                            { icon: Linkedin01Icon, href: "https://www.linkedin.com/in/muhammad-rois-8a4a74283/", color: "text-blue-600 hover:text-blue-700" },
                                            { icon: TiktokFreeIcons, href: "https://www.tiktok.com/@ig_roisdev", color: "text-black dark:text-gray-200 hover:text-gray-700" },
                                            { icon: InstagramIcon, href: "https://www.instagram.com/roisdev_/", color: "text-pink-500 hover:text-pink-600" },
                                            ...
                                            >
                                                <HugeiconsIcon icon={SocialIcon.icon} className="h-5 w-5" />
                                            </a>
                                        ))}
